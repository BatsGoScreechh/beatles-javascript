...
const form = beatles.history.formed
const disband = beatles.history.disbanded
const paulBirth = beatles.members[1].birth
const magicAlbum = beatles.albums[3]

console.log(paul,"was in the Beatles from", form, "to", disband, ". He was born in", paulBirth,". He contributed to the", magicAlbum, "Album.")